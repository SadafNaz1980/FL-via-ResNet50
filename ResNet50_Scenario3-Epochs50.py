...
img_path=r'../DL_Scenario1.5/data_DL_Scenario1.5/COVID/COVID-4.png'
...
sdir=r'../DL_Scenario1.5/data_DL_Scenario1.5'
#sdir=r'C:/Users/sadaf/Desktop/Scenario_1/DL_Scenario1'
train_df, test_df, valid_df=process_data(sdir, .8,.1)
...
#train_df is not balanced and has a very large number of images which will lead to long training times
#To balance training dataframe limit maximum number of samples in a class to 1000 samples
#limit test_df and valid_df to 200 samples per class
...
#The train_df dataframe is now balanced with 4000 samples per class
...
base_model = ResNet50(input_shape = img_shape, # Shape of our images
...
stop_patience =20 # number of epochs to wait before stopping training if monitored value does not improve
...
tr_plot(history,0)
subject='chest xrays'
acc=model.evaluate( test_gen, verbose=1, steps=test_steps)[1]*100 #, return_dict=False
